...
import pH0 from "./images/pHighlight_0.png";
import pH1 from "./images/pHighlight_1.png";
import pH2 from "./images/pHighlight_2.gif";
import pH3 from "./images/pHighlight_3.png";
import pH4 from "./images/pHighlight_4.gif";
...
export const getTags = (): string[] => Object.keys(tags).map(k => tags[k]);

export const getProjectTitle = (id: number): string => projects.find(p => p.id === id).title;

export const getProjects = (filterText: string, filterTags: string[]): Project[] => {
