                    ...
                    <div className={`${styles.bio} ${revealBio ? styles.active : ""}`}>
                        ...
                        <div className={styles.content}>
                            <p>
                                ...
                                When I think about my childhood, I often relive the moments when I was exploring my PC
                                and,
                                more
                                specifically, games.
                                <strong>Video Games</strong> were a big part of my life back then and I always
                                appreciated
                                and
                                was
                                ...
                                <br/>
                                Spending most of my free time on the computer, it came as a shock when I enrolled myself
                                in
                                The
                                Faculty of Law. Nevertheless, after just 1 year I quickly
                                realised that I want to spend the rest of my life doing the things I really enjoy. I
                                wanted
                                to
                                have
                                a reason to get up in the morning. At that point, I didn't
                                know how to program a computer. I was just intrigued by the "fancy colors and texts"
                                that
                                were
                                popping on my programmer friends' monitors.
                                <br/>
                                So I did it. I dropped Law and everything that I did for the last 4 years at that point
                                to
                                prepare
                                for that path and started to learn programming.
                                Immediately, I was hooked. My journey started with the C Programming Language and I'm
                                very
                                grateful
                                ...
                                mainly as a back-end engineer for diverse companies and projects. As a personal
                                achievement,
                                I
                                managed to open my own company 2 years ago and I've been working as a contractor.
                                Because of this, I could safely explore other industries while also keeping a decent
                                stream
                                of
                                income from my web contracts.
                                <br/>
                                Soon after, I realised why computers were so dear to me back when i first received one.
                                It
                                was <strong>video games</strong>.
                                <br/>
                                That's why now I am a <strong>student</strong> once again. I decided, once again, to
                                take a
                                big
                                leap
                                for my career and "start over". Dropped all my contracts and took a break from working
                                in
                                order
                                to
                    ...
                    <div className={styles.content}>
                        <Appear sourceDirection={"right"}>
                            <p>
                                ...
                                agnostic</strong>.
                                <br/>
                                Technology advances and new trends appear every day. I believe it is more important in
                                learning and understanding concepts and techniques rather than tools.
                                <br/>
